...
`Fe II`| [Den Hartog et al. (2019, ApJS, 243, 33)](https://ui.adsabs.harvard.edu/abs/2019ApJS..243...33D); most of the new laboratory data are for UV lines, but enough blue lines (10 of them) are included that it is clear that the Meléndez & Barbuy (2009, A&A, 497, 611) empirical values were more reliable than those at the NIST website.  Our choice here is to use the Den Hartog values when available, otherwise to use the Melendez & Barbuy values
