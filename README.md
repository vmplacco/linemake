...
- 2018-03-17: Added new Co II lab data, and published lab data for mostly 
  neutron-capture species lines (mostly in the UV) employed 
  in recent papers by Ian Roederer
...
Co II:  Lawler et al. (2018, ApJS, submitted); there are 12 lines in this paper
with good lab hfs patterns.  To these we have added another 4 lines with new
gf values but approximate hfs patters from the Co I paper; these will appear
