...
`Fe II`|  Den Hartog et al. (2019, ApJS, 243, 33); most of the new laboratory data are for UV lines, but enough blue lines (10 of them) are included that it is clear that the Mel{\' e}ndez \& Barbuy (2009, A\&A, 497, 611) empirical values were more reliable than those at the NIST website.  Our choice here is to use the Den Hartog values when available, otherwise to use the Melendez & Barbuy values.
...
`Ni II`| discussed in the Ni I paper, but awaits a fresh study; not included here; this will be the subject of a future Wisconsin lab effort; note that `Co II` lines in the [Kurucz](http://kurucz.harvard.edu/atoms.html) database have no HFS information.     
...
Species|Notes
-------|-----
`Li I`| Resonance line. Nothing special needs to be done here to get the full isotopic and hyperfine substructure. The total *gf* from [Kurucz](http://kurucz.harvard.edu/atoms.html), has been adopted; it is close to that recommended by NIST.
